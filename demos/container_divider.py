...
def main() -> None:
    ...
    with App(title="Demo: HTMLDivider") as app:
        # Title
        title = HTMLString("HTMLDivider Demo").bold().xxl()
        app.add(title)
        app.add(HTMLString("Visual separators for content sections").muted())

        time.sleep(0.5)

        # Section 1: Basic Horizontal Divider
        app.add(HTMLString("Basic Horizontal Divider").bold().xl().styled(margin_top="20px"))
        app.add(HTMLString("Content above the divider"))
        app.add(HTMLDivider())
        app.add(HTMLString("Content below the divider"))

        time.sleep(0.8)

        # Section 2: Dividers with Labels
        app.add(HTMLString("Dividers with Labels").bold().xl().styled(margin_top="24px"))

        app.add(HTMLString("Use labeled dividers to indicate sections"))
        app.add(HTMLDivider("OR"))
        app.add(HTMLString("Alternative option below"))

        time.sleep(0.5)

        app.add(HTMLDivider("SECTION BREAK"))

        time.sleep(0.8)

        # Section 3: Line Styles
        app.add(HTMLString("Line Styles").bold().xl().styled(margin_top="24px"))
        ...
        app.add(style_column)

        time.sleep(0.8)

        # Section 4: Colors
        app.add(HTMLString("Custom Colors").bold().xl().styled(margin_top="24px"))
        ...
        app.add(color_column)

        time.sleep(0.8)

        # Section 5: Thickness
        app.add(HTMLString("Thickness Variations").bold().xl().styled(margin_top="24px"))
        ...
        app.add(thickness_column)

        time.sleep(0.8)

        # Section 6: Presets
        app.add(HTMLString("Presets").bold().xl().styled(margin_top="24px"))
        ...
        app.add(preset_column)

        time.sleep(0.8)

        # Section 7: Vertical Dividers
        app.add(HTMLString("Vertical Dividers (in Rows)").bold().xl().styled(margin_top="24px"))
        ...
        app.add(HTMLString("Real-World Example: Login Form").bold().xl().styled(margin_top="24px"))
